...
import com.bgsoftware.superiorskyblock.world.schematic.impl.OneBlockSchematic;
...
public class SchematicsManagerImpl extends Manager implements SchematicManager {
    ...
    private void registerVirtualOneBlockSchematics() {
        this.schematicsContainer.addSchematic(new OneBlockSchematic("oneblock"));
        this.schematicsContainer.addSchematic(new OneBlockSchematic("oneblock_nether"));
        this.schematicsContainer.addSchematic(new OneBlockSchematic("oneblock_the_end"));
    }

    public void loadSchematics()
 throws ManagerLoadException {
        this.schematicsContainer.clearSchematics();

        // Virtual schematics registered before file check so the empty-check below counts them
        registerVirtualOneBlockSchematics();
