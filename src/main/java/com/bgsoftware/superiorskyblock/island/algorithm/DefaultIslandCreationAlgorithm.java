...
public class DefaultIslandCreationAlgorithm implements IslandCreationAlgorithm {
    ...
    private CompletableFuture<IslandCreationResult> createIslandInternal(IslandBuilderImpl builder, BlockPosition lastIsland) {
        ...
        Log.debug(Debug.CREATE_ISLAND, builder.owner.getName(), schematic != null ? schematic.getName() : builder.islandType, lastIsland);
        ...
        long profiler = Profiler.start(ProfileType.CREATE_ISLAND, schematic != null ? schematic.getName() : builder.islandType);
