...
import com.bgsoftware.superiorskyblock.module.evolvedskills.EvolvedSkillsModule;
...
public class BuiltinModules {
    ...
    public static final EvolvedSkillsModule EVOLVED_SKILLS = new EvolvedSkillsModule();
