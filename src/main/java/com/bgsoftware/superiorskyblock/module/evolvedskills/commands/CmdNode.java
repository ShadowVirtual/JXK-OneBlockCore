...
public class CmdNode implements ISuperiorCommand {

    private final EvolvedSkillsService service;

    public CmdNode(EvolvedSkillsService service) {
    ...
    public String getPermission() {
        return "superior.island.node";
    }

    @Override
    public String getUsage(java.util.Locale locale) {
        return "node [status|harvest|upgrade]";
    }

    @Override
    public String getDescription(java.util.Locale locale) {
        return "Manage evolved resource nodes.";
    }
    ...
    public void execute(SuperiorSkyblockPlugin plugin, CommandSender sender, String[] args) {
        ...
        service.executeNodeCommand(sender, superiorPlayer, args);
    }
